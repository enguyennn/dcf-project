# Requirements Document (REQ) Authoring Standards

Content creation standards and requirements for `.req.md` documents.
...
- The Assumptions and Interpretations section (Section 6) MUST be populated — do not leave it empty or treat it as optional
...
[Surface all assumptions made and interpretations chosen during requirements analysis. This section enables reviewers to catch misunderstandings before they propagate into planning and implementation.]

### Assumptions

[List every assumption made that is not explicitly stated in the original request. Each assumption should be specific enough that a reviewer can confirm or reject it.]

| ID | Assumption | Confidence | Impact if Wrong | Traces To |
|----|-----------|------------|-----------------|-----------|
| ASM-001 | [What was assumed] | [High/Medium/Low] | [What breaks if this assumption is incorrect] | FR-001 |
| ASM-002 | [What was assumed] | [High/Medium/Low] | [What breaks if this assumption is incorrect] | NFR-001 |

### Alternative Interpretations

[Document cases where the original request was ambiguous and multiple valid interpretations existed. State which interpretation was chosen and why, so reviewers can validate the choice.]

| ID | Ambiguity | Chosen Interpretation | Alternatives Considered | Rationale |
|----|-----------|----------------------|------------------------|-----------|
| ALT-001 | [What was ambiguous] | [What was chosen] | [Other valid readings] | [Why this one was selected] |
